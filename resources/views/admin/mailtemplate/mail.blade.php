                ...
                <table class="es-content" cellspacing="0" cellpadding="0" align="center" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;table-layout:fixed !important;width:100%">
                    ...
                    <tr style="border-collapse:collapse">
                        <td align="center" style="padding:0;Margin:0">
                            <table class="es-header-body" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;background-color:#282A3C;width:600px" cellspacing="0" cellpadding="0" bgcolor="#282a3c" align="center">
                                <tr style="border-collapse:collapse">
                                            ...
                                            <tr style="border-collapse:collapse">
                                                <td class="es-m-p0r" valign="top" align="center" style="padding:0;Margin:0;width:530px">
                                                    <table width="100%" cellspacing="0" cellpadding="0" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                                                        <tr style="border-collapse:collapse">
                                                            <td align="center" style="padding:0;Margin:0;font-size:0px"><img class="adapt-img" src="https://fhpqdd.stripocdn.email/content/guids/CABINET_d98fd8647411195dbfc9c734e3b33860/images/31741610085949174.png" alt style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic" width="220"></td>
                                                        </tr>
                                                    </table></td>
                                            </tr>
                                        </table></td>
                                            ...
                                            <tr style="border-collapse:collapse">
                                                <td class="es-m-p0r" valign="top" align="center" style="padding:0;Margin:0;width:0px">
                                                    <table width="100%" cellspacing="0" cellpadding="0" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                                                        <tr style="border-collapse:collapse">
                                                            <td align="center" style="padding:0;Margin:0">
                                                                <a href="https://www.facebook.com/INTUNOR/" target="_blank">
                                                                    <img src="{{ URL::asset('public/assets/demo/default/media/img/logo/outline-light-facebook-48.png') }}" class="" width="24" height="24">
                                                                </a>&nbsp;&nbsp;<a href="https://twitter.com/Intunor1" target="_blank">
                                                                    <img src="{{ URL::asset('public/assets/demo/default/media/img/logo/outline-light-twitter-48.png') }}"  class="" width="24" height="24">
                                                                </a>&nbsp;&nbsp;<a href="https://www.instagram.com/intunorgroup/" target="_blank">
                                                                    <img src="{{ URL::asset('public/assets/demo/default/media/img/logo/logo-instagram-preto-e-branco-png-5.png') }}" class="" width="24" height="24">
                                                                </a>
                                                            </td>

                                                        </tr>
                                                        <tr style="border-collapse:collapse">
                                                            <td align="center" style="padding:0;Margin:0"><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:14px;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif;line-height:21px;color:#FFFFFF">INTUNOR Integrator<br>Haslevangen 15, 0579 Oslo, Norway<br><a style="color: #fff;" href="tel:+4745898989" >+47 458 98 989</a>&nbsp; &nbsp; | &nbsp; &nbsp; <a style="color: #fff;" href="mailto:support@intunor.com">support@intunor.com</a></p></td>
                                                        </tr>
                                                    </table></td>
                                            </tr>
                                        </table></td>
