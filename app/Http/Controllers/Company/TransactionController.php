    ...
    public function getall(Request $request)
    {
        ...
        return DataTables::of($transactions)
            ->addColumn('actions', function ($q) {
                $id = $q->id;
                $return = '<a style="color:#000; margin-right:10px;"  href="'.route('company.form.copy',$q->id).'"><i class="fas fa-copy" style="color:#616161;"></i></a> <a style="color:#000; margin-right:10px;"  data-id="'.$id.'"   data-toggle="modal" data-target=".add_modal" class="openaddmodal"   ><i class="fas fa-history" style="color:#616161;"></i></a>  <a style="color:#000; margin-right:10px;"  href="'.route('company.form.download',$q->id).'"  ><i class="fas fa-download" style="color:#616161;"></i></a> <a style="color:#000; margin-right:10px;"  href="'.route('company.form.edit',$q->id).'"  ><i class="fas fa-pen" style="color:#616161;"></i></a> <a class="delete_record" style="color:#000;cursor:pointer; margin-right:10px;" data-id="'.$q->id.'"><i class="fas fa-trash" style="color:#616161;"></i></a> ';
